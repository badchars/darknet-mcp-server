...
If you discover a security vulnerability in darknet-mcp-server, please report it responsibly.
...
This security policy covers the **darknet-mcp-server codebase only**. It does not cover:

- Third-party APIs that darknet-mcp-server connects to (HIBP, abuse.ch, GreyNoise, etc.)
- Vulnerabilities in upstream dependencies (report those to the respective maintainers)
- Issues in the Tor network or SOCKS5 proxy infrastructure
